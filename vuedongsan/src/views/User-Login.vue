      ...
      <div class="md:w-8/12 lg:w-5/12 lg:ml-20">
        <form>
          ...
          <div class="flex justify-between items-center mb-6">
            ...
            <a
              href="#!"
              class="mr-3 text-blue-600 hover:text-blue-700 focus:text-blue-700 active:text-blue-800 duration-200 transition ease-in-out text-xs"
              >Forgot password?</a>

            <a
              href="/singup"
              class="text-blue-600 hover:text-blue-700 focus:text-blue-700 active:text-blue-800 duration-200 transition ease-in-out text-xs"
              >SingUp?</a>
            </div>
          </div>
          <!-- Submit button -->
